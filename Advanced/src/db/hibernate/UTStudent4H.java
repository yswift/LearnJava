...
public class UTStudent4H {
    static Long oneDay = 24 * 60 * 60 * 1000L;

    Connection connection;
    Student4H studentExercise;

    public UTStudent4H() throws SQLException {
        H2DbHelper helper = new H2DbHelper();
        connection = helper.getConnection();
        studentExercise = new Student4H();
    }
    ...
    public void testInsert() throws SQLException {
        ...
        // 插入数据
        Student s = new Student(0, no, name, age, birthday);
        studentExercise.insert(s);
        // 找到插入数据
    ...
    public void testUpdate() throws SQLException {
        ...
        Date birthday = new Date(b - b % oneDay);
        // 修改数据
        Student s = new Student(id, no, name, age, birthday);
        studentExercise.update(s);
        // 找到插入数据
        rs = executeQuery(" id=" + id);
        // 验证
        check(rs, no, name, age, birthday);
